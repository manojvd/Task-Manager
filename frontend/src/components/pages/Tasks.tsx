...
import { Plus, Search, Filter, Edit, Trash2, CheckCircle, Clock, AlertCircle, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const Tasks: React.FC<TasksProps> = ({ tasks, loading, onNavigate, onDeleteTask }) => {
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <Label>Sort By</Label>
              <Select value={sortBy} onValueChange={(value: string) => setSortBy(value as 'createdAt' | 'dueDate' | 'priority')}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => onNavigate(`/tasks/${task.id}/edit`)}
